...
const translations = {
  de: {
    ...
    error_file_too_large: 'Datei zu groß (max. 50 MB)',
    error_unsupported_format: 'Format nicht unterstützt (JPEG, PNG, GIF, WebP, TIF/TIFF)',
    error_image_load: 'Bild konnte nicht geladen werden',
    page_label: 'Seite {n}',
    editor_tab: 'Editor',
  ...
  en: {
    ...
    exporting: 'Exporting...',
    error_file_too_large: 'File too large (max. 50 MB)',
    error_unsupported_format: 'Unsupported format (JPEG, PNG, GIF, WebP, TIF/TIFF)',
    error_image_load: 'Image could not be loaded',
    page_label: 'Page {n}',
    editor_tab: 'Editor',
    preview_tab: 'Preview',
